...
from memory_agent.policies.structured import StructuredMemoryPolicy, is_chat_policy
...
def _profile_rules(policy: StructuredMemoryPolicy) -> str:
    ...
    if policy.retention_semantics == "evaluation":
        return (
...
def _value_rules(policy: StructuredMemoryPolicy) -> str:
    if is_chat_policy(policy):
        return ""
    return (
...
def _batch_rules(policy: StructuredMemoryPolicy) -> str:
    if is_chat_policy(policy):
        return (
...
def _assistant_rules(policy: StructuredMemoryPolicy) -> str:
    if is_chat_policy(policy):
        return (
...
def _phrasing_rules(policy: StructuredMemoryPolicy) -> str:
    suffix = (
...
def _detail_rules(policy: StructuredMemoryPolicy) -> str:
    if is_chat_policy(policy):
        return (
