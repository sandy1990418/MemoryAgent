...
def _chat_updater_system(
    *,
    ...
    return (
        ...
        '- NOOP {"op":"NOOP"}\n\n'
        "CHAT POLICY rules:\n"
        "- Default to NOOP for conversational noise. Do not NOOP an explicit durable user self-report: save positive or negative reports about their experience, completed or ongoing work, current project state, preferences, goals, decisions, blockers, measured results, failed attempts, and corrections.\n"
        ...
        "- Direct durable user state (preferences, goals, facts, corrections, and decisions) takes priority over optional discussion/progress rollups under the three-operation cap; never let assistant-derived progress crowd out direct user state.\n"
        ...
        "- Progress requires a direct user report of completed work, ongoing work, an observed result, or a measured milestone. A substantive discussion alone is not progress. Never convert assistant explanations, examples, plans, generated code, or proposed outcomes into progress.\n"
